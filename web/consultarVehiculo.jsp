                                            ...
                                            <div class="modal-body">
                                                ...
                                                <form method="post" action="Vehiculo">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" name="textPlaca" class="form-control" id="inputEmail" value="" />
                                                    </div>
                                                    <div class="form-group">

                                                        <input type="hidden" name="textDatId" class="form-control" id="inputEmail" value="<%=datpVO.getDatId()%>" />
                                                    </div>
                                                    <div class="form-group">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" name="textModelo" class="form-control" id="inputEmail" value="" />
                                                    </div>
                                                    <div class="form-group">
                                                        <label for="txtNombre">Marca:</label>
                                                        <input type="text" name="textMarca" class="form-control" id="inputEmail" value="" />
                                                    </div>
                                                    <div class="form-group">
                                                        <label for="txtNombre">Estado</label>
                                                        <select name="textEstado" required>
                                                            <option> NUEVO </option>
                                                            <option> USADO </option>
                                                        </select>      
                                                    </div>
                                                    <div class="form-group">
                                                        ...
                                                        <input type="int" name="textPrecio" class="form-control" id="inputEmail" value="" />
                                                    </div>
                                                ...
                                                <div class="modal fade" id="modal<%=i%>" role="dialog">
                                                    <div class="modal-dialog">
                                                        <div class="modal-content">
                                                            <!-- Modal Header -->
                                                            <div class="modal-header">
                                                                <h4 class="modal-title" id="myModalLabel">Actualizar Vehículo</h4>
                                                                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                                                    <span aria-hidden="true">&times;</span>
                                                                </button>
                                                            </div>
                                                            ...
                                                            <div class="modal-body">
                                                                ...
                                                                <form class="formulario" method="post" action="Vehiculo">
                                                                    <div class="form-group">
                                                                        <label for="textId" >Placa:</label>
                                                                        <input  type="text" name="textPlaca" class="form-control" id="inputName"  value="<%=vehVO.getVehPlaca()%>" readonly />
                                                                    </div>
                                                                    <div class="form-group">

                                                                        <input type="hidden" name="textDatId" class="form-control" id="inputEmail"  value="<%=vehVO.getDatId()%>" readonly/>
                                                                    </div>
                                                                    <div class="form-group">
                                                                        <label for="txtNombre">Categoria:</label>
                                                                        <select name="textCatId" value="<%=vehVO.getCatId()%>">
                                                                            <option>Seleccione...</option>
                                                                            <%
                                                                    ...
                                                                    <div class="form-group">
                                                                        <label for="txtNombre">Modelo:</label>
                                                                        <input type="text" name="textModelo" class="form-control" id="inputEmail"  value="<%=vehVO.getVehModelo()%>" />
                                                                    </div>
                                                                    <div class="form-group">
                                                                        <label for="txtNombre">Marca:</label>
                                                                        <input type="text" name="textMarca" class="form-control" id="inputEmail"  value="<%=vehVO.getVehMarca()%>" />
                                                                    </div>
                                                                    <div class="form-group">
                                                                        <label for="txtNombre">Estado</label>
                                                                        <select name="textEstado" required>
                                                                    ...
                                                                    <div class="form-group">
                                                                        <label for="txtNombre">Precio</label>
                                                                        <input type="text" name="textPrecio" class="form-control" id="inputEmail"  value="<%=vehVO.getVehPrecio()%>" />
                                                                    </div>
                                            ...
                                            <td>
                                                ...
                                                <form method="POST" action="Cliente" id="delete">    
                                                    <div class="frm-g-input">
                                                        <input type="hidden" placeholder="Nombre"  name="textCliId" value="<%=vehVO.getVehPlaca()%>">
